...
// * =============================================
// */
//public class NewEventPandectFragment extends Fragment implements GetExercisingView, GetIncomeView, GetUserInfoView, UpdateVersionView, BaseQuickAdapter.OnItemClickListener,
...
//                NewEventPandectFragment.this.withDraw();
//                break;
...
//            NewEventPandectFragment.this.reTryGetEvent();
//        }
//
//    }
//
...
//        } else {
//            // 创建一个数据集,并给它一个类型
//            set1 = new LineDataSet(yVals1, "收入");
...
//    public void signIn() {
//        PageTool.go(getActivity(), BarCodeCheckIn.class, null);
//    }
//
...
//            exhibitorAdapter.removeHeaderView(itemView);
...
//        rvHomeExhibition.setLayoutManager(new LinearLayoutManager(getContext(),
...
//            footerViewBind.tvPageStatus.setText("暂无进行中的活动");
...
//        TosUtil.show("获取人数数据失败，请检查网络是否连接！");
//    }
//
//    /**
//     * 显示收入
...
//        TosUtil.show("获取收入数据失败，请检查网络是否连接！");
//    }
//
//    @Override
...
//            bundle.putString("account", tvAccountBalance.getText().toString());
...
//        tvAccountBalance.setText(format.format(bean.getBalance()) + "");
//        tvMsgBalance.setText(bean.getSmsBalance() + "");
...
//              tvNewAddIncome.setText("￥ 0");
//            } else if (bean.getRmbIncome() != 0 && bean.getDollarIncome() == 0) {
//                tvNewAddIncome.setText("￥" + setBigDecimal(bean.getRmbIncome()));
//            } else if (bean.getRmbIncome() == 0 && bean.getDollarIncome() != 0) {
//                tvNewAddIncome.setText("$" + setBigDecimal(bean.getDollarIncome()));
//            } else {
//               tvNewAddIncome.setText("￥" + setBigDecimal(bean.getRmbIncome()) + "  $" + setBigDecimal(bean.getDollarIncome()));
//            }
//            tvYesterdayAttendee.setText("昨日新增人数");
//            tvYesterdaySale.setText("昨日新增收入");
//            tvNewAddAttendee.setText(bean.getNewAttendees() + "");
//        } else {
//            IncomeData.RespObjectBean bean = response.getRespObject();
//            if (bean.getTodayRmbIncome() == 0 && bean.getTodayDollarIncome() == 0) {
//               tvNewAddIncome.setText("￥ 0");
//            } else if (bean.getTodayRmbIncome() != 0 && bean.getTodayDollarIncome() == 0) {
//                tvNewAddIncome.setText("￥" + setBigDecimal(bean.getTodayRmbIncome()));
//            } else if (bean.getTodayRmbIncome() == 0 && bean.getTodayDollarIncome() != 0) {
//                tvNewAddIncome.setText("$" + setBigDecimal(bean.getTodayDollarIncome()));
//            } else {
//                tvNewAddIncome.setText("￥" + setBigDecimal(bean.getTodayRmbIncome()) + "  $" + setBigDecimal(bean.getTodayDollarIncome()));
//            }
//            tvYesterdayAttendee.setText("今日新增人数");
//            tvYesterdaySale.setText("今日新增收入");
//            tvNewAddAttendee.setText(bean.getTodayAttendees() + "");
//        }
//
//    }
//
