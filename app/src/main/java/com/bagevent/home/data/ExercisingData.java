...
public class ExercisingData {
    ...
    public static class RespObjectBean {
        ...
        public static class ApiEventListBean {
            ...
            private int exType;
            private int hasLiveModule;

            public int getHasLiveModule() {
                return hasLiveModule;
            }

            public void setHasLiveModule(int hasLiveModule) {
                this.hasLiveModule = hasLiveModule;
            }
